        ...
        <div class="box-body">
          ...
          <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label for="meta_des">Tool Summary</label>
                  <textarea placeholder="Enter tool summary within 1000 Characters" rows="3" name="tool_summary" class="form-control resize-vertical"><?php echo $tool_summary; ?></textarea>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <textarea placeholder="keywords1, keywords2, keywords3" rows="3" name="meta_tags" class="form-control resize-vertical"><?php echo $meta_tags; ?></textarea>
                </div>

                <div class="form-group">
                    <label for="meta_des">Meta Description</label>
                    <textarea placeholder="Description must be within 150 Characters" rows="3" name="meta_des" class="form-control resize-vertical"><?php echo $meta_des; ?></textarea>
                </div>
              </div>
          </div><!-- /.row -->
