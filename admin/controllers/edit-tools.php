...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $tool_summary = escapeTrim($con,$_POST['tool_summary']);
    ...
    $query = "UPDATE seo_tools SET tool_name='$tool_name', tool_summary='$tool_summary', tool_url='$tool_url', tool_no='$tool_no', tool_show='$tool_show', meta_title='$meta_title', meta_des='$meta_des', meta_tags='$meta_tags', captcha='$captcha', about_tool='$about_tool', tool_login='$tool_login' WHERE id='$dID'";
