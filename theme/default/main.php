        ...
        foreach ($tools as $tool)
        {
            ...
            <div class="col-md-6">
                <div class="row row-equal">
                    <div class="col-sm-3">
                        <img alt="'.$tool[0].'" src="'.themeLink($tool[2],true).'" class="seotoolimg" />
                    </div>
                    <div class="col-sm-9">
                        <h3><a class="seotoollink" data-placement="top" data-toggle="tooltip" data-original-title="'.$tool[0].'" title="'.$tool[0].'" href="'.$tool[1].'">'.$tool[0].'</a></h3>
                        <p class="text-justify"><strong>'.$tool[5].'</strong></p>
                    </div>
                </div>
            </div>';
            if ($loop%2==0) {
            ...
            // <div class="col-md-3">
            //     <div class="thumbnail">
            //         <a class="seotoollink" data-placement="top" data-toggle="tooltip" data-original-title="'.$tool[0].'" title="'.$tool[0].'" href="'.$tool[1].'">
            //             <img alt="'.$tool[0].'" src="'.themeLink($tool[2],true).'" class="seotoolimg" />
            //             <div class="caption">
            //                     '.$tool[0].'
            //             </div>
