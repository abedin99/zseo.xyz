...
<body>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle"
                            aria-expanded="false"><i class="fa fa-globe fa-lg"></i> &nbsp;
                            <?php echo strtoupper(ACTIVE_LANG); ?></a>
    ...
    <div class="masthead">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img class="visible-lg visible-md" alt="<?php echo $lang['317']; ?>"
                        src="<?php themeLink('img/seobanner.png'); ?>" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="submasthead">
        <div class="container">
            <div class="col-md-6 seobannerSmall">
                ...
                <p><strong><?php echo $tool_summary; ?></strong></p>
            </div>

            <div class="col-md-6">
                <img class="visible-lg visible-md" alt="<?php echo $lang['317']; ?>"
                    src="<?php themeLink('img/seobanner_mini.png'); ?>" />
            </div>
        </div>
    </div>
    ...
    <script>
    window.location.href = "<?php createLink('maintenance') ?>";
    </script>
    <?php } ?>
